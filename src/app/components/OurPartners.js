  ...
  return (
    ...
    >
      ...
      <Box sx={{
        ...
        pointerEvents: "none", animation: "orb-drift 22s ease-in-out infinite reverse",
      }} />
      ...
      <Box sx={{ position: "relative", zIndex: 1 }}>
        ...
        <Box sx={{
          ...
          <Box>
            ...
            <Typography sx={{
              ...
              <Box component="span" sx={{ color: ORANGE }}>& businesses.</Box>
            </Typography>
          </Box>
          <Typography sx={{
            ...
            We collaborate with IT agencies and growing businesses to deliver results that scale.
          </Typography>
        </Box>
        ...
        <Box sx={{
          ...
          {[
            { stat: "50+", label: "Technologies & tools" },
            { stat: "99.9%", label: "Average uptime SLA" },
            { stat: "3×", label: "Faster time-to-market" },
          ].map(({ stat, label }) => (
            <Box key={stat}>
              <Typography sx={{
                fontFamily: FD, fontWeight: 800,
              ...
              <Typography sx={{
                ...
                color: "#999", fontWeight: 600, mt: "6px",
                letterSpacing: "0.2px",
              }}>
                {label}
              </Typography>
